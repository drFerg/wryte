      ...
      <div class="relative px-4 sm:px-8 lg:px-12">
        <div class="mx-auto max-w-2xl lg:max-w-5xl">
          <header class="max-w-2xl">
            ...
            >
              Writing on software engineering, startups and other tidbits.
            </h1>
            <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">
              All of my long-form thoughts on programming, startups, engineering, and more.
            </p>
          </header>
                ...
                <article class="md:grid md:grid-cols-4 md:items-baseline">
                  <div class="md:col-span-3 group relative flex flex-col items-start">
                    ...
                    >
                      ...
                      <a href={null}
                        ...
                        ><span class="relative z-10"
                          >Moving from React to SvelteKit, progressively.</span
                        ></a
                      >
                    </h2>
                    <time
                    ...
                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                      ...
                      engineers) into SvelteKit, to enable us to progressively enhance the frontend
                      with Svelte + Kit whilst minimising impact on product velocity.
                    </p>
                    <div
                      aria-hidden="true"
